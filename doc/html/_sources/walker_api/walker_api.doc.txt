...
The Core Walker Application Programming Interface (API)
--------------------------------------------------------
...
Setting Walker Output Files
<<<<<<<<<<<<<<<<<<<<<<<<<<<<

.. automodule:: outputClass
		:members:

Setting Walker Collective Variables
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

.. automodule:: collectiveVariables
		:members:
