...
class string:
    """
    A string object houses the properties and methods needed for executing a string
    method calculation. 
    """
    ...
    def setColvars(self, cvs):
        """
        This function sets the colvars data structure needed for the string to 
        operate. Also sets up a numpy array for storing the state of the string.  
        """
