...
class partition:
    ...
    def sample(self, numSteps, umbrellaIndex, walkerIndex, sysParams, rank=-1):
        ...
        # equilibrate the system at the starting position for the current umbrella.
        #print "Dragging walker to", self.umbrellas[umbrellaIndex].center
        wlkr.equilibrate(self.umbrellas[umbrellaIndex].center)
